...
3. **Evidence** — records are hash chained; builds and test outputs are content addressed with Merkle leaves that bind canonical artifact path, byte length, and SHA-256 content digest.
